...
const exps = db.expenses.find({ periodicity: "monthly", deleted: false, date: '2022-02-01' }).toArray();

exps.forEach((it) => (it.updatedAt = updatedAt));
exps.forEach((it) => (it.date = "2022-03-01"));
